...
$con=mysqli_connect("localhost","root","","bd_jobbox");
	...
	if(count($_POST) > 0){
		...
		switch ($mode) {
			case 'enter_email':
				...
				$_SESSION['forgot']['email_empresa'] = $email;
				send_email($email);
			...
			case 'enter_password':
						# code...
						$password = $_POST['senha_empresa'];
						$password2 = $_POST['senha_empresa2'];
						
						if($password !== $password2){
							$error[] = "As senhas não correspondem!";
						}elseif(!isset($_SESSION['forgot']['email_empresa']) || !isset($_SESSION['forgot']['code'])){
	...
	function send_email($email){
		...
		$query = "insert into codes_empresa (email_empresa,code,expire) value ('$email','$code','$expire')";
	...
	function save_password($password){
		...
		$email = addslashes($_SESSION['forgot']['email_empresa']);


		$query = "update tb_empresa set senha_empresa = '$password' where email_empresa = '$email' limit 1";
		mysqli_query($con,$query);
	...
	function valid_email($email){
		...
		$query = "select * from tb_empresa where email_empresa = '$email' limit 1";
	...
	function is_code_correct($code){
		...
		$query = "select * from codes_empresa where code = '$code' && email_empresa = '$email' order by id desc limit 1";
		$result = mysqli_query($con,$query);
		if($result){
			if(mysqli_num_rows($result) > 0){
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./navs_sendmail_empresa/style.css">
	<!--===============================================================================================-->
...
<div id="js-preloader" class="js-preloader">
	...
	<?php 
		include "./navs_sendmail_empresa/navNew.php";
	?>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<?php
					...
					<br>
							...
							<input class="input100" type="email" name="email_empresa" placeholder="Email">
							...
							<br><br><br>
							<div><a href="../telaloginEmpresa.php" class="login100-form-btn">Voltar ao Login</a></div>
							</div>
						</form>
			...
			<?php
						...
						case 'enter_password':
							...
							<div class="wrap-input100">
							<input  class="input100" type="text" name="senha_empresa" placeholder="Nova senha"><br>
							<input  class="input100" type="text" name="senha_empresa2" placeholder="Repita a nova senha"><br>
							</div>
 ...
 <div class="footer">
  ...
  <span aria-hidden="true" class="theme-toggler__switch"></span>
	...
	<script src="./navs_sendmail_empresa/script.js"></script>
