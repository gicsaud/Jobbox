...
<html>
  <head>
    ...
    <link href="./navs_CandidatoLog/style.css" rel="stylesheet" type="text/css">
  ...
  <div id="js-preloader" class="js-preloader">
    <div class="preloader-inner">
      ...
      <div class="dots">
  	 ...
  	 <header>
 <?php include './navs_CandidatoLog/navNew.php'; ?>
     </header>
      ...
      <div class="access-links">
        <div class="access-link-wrapper">
          ...
          <div class="access-icon">
           <img src="./prototipo_acesso rapido/dist/imagens/perfil_icon.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image"></a>
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/>
              <circle cx="8.5" cy="8.5" r="1.5"/>
              <polyline points="21 15 16 10 5 21"/>
            </svg>
          </div>
          <span class="access-text" >Meu perfil</span>
        </div>
        <div class="access-link-wrapper">
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./FAQCandidato/FAQ.php"> <img src="./prototipo_acesso rapido/dist/imagens/ajuda_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-left"></a>
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./Configs_logadoCandidato.php"> <img src="./prototipo_acesso rapido/dist/imagens/configuracoes_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-left"></a>
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./sairCandidato.php"><img src="./prototipo_acesso rapido/dist/imagens/entrar_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"></a>
...
<script src="vendor/tilt/tilt.jquery.min.js"></script>
    ...
    <script  src="./navs_CandidatoLog/script.js"></script>
