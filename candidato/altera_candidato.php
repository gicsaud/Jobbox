<?php
  ...
  nome_candidato='$nome',data_nascimento='$data_nascimento',cpf_candidato='$cpf',telefone_candidato='$telefone',email_candidato='$email',senha_candidato='$senha',cep_candidato='$cep',rua_candidato='$rua',bairro_candidato='$bairro',num_candidato='$num',complemento_candidato='$complemento'
