...
<?php 
	include "conexao.php";
/* 	$senha_candidato = password_hash('senha_candidato', PASSWORD_DEFAULT);
	$query = "update tb_candidato set senha_candidato = '$senha_candidato'";
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Digite uma senha">
						<input class="input100" type="password" name="trocar_senha" placeholder="Nova senha">
