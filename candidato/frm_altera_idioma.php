...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./main_infos.css">
...
<?php
    ...
    $comandoSql = "select * from tb_idioma where id_idioma='$id_idioma'";
...
<div class="app-container">
  ...
  <div class="app-content">
    ...
    <div class="limiter">
        ...
        <form class="login100-form validate-form" action="altera_idioma.php" method="POST">
                <span class="login100-form-title">
                    Idiomas
                </span>
                
                <input class="input100" type="hidden" id="id_idioma" name="id_idioma" readonly value="<?php echo $id_idioma ?>">
                <div class="wrap-input100 validate-input" data-validate="Nome inválido: Digite o nome do cargo">
                    <input class="input100" type="text" name="nome_idioma" value="<?php echo $nome_idioma ?>" id="nome_idioma" placeholder="Idioma">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">

                    </span>
                </div>
                <div class="wrap-input100 validate-input" data-validate="Nível de fluência" value="<?php echo $nivel_fluencia ?>">

<select id="nivel_fluencia" name="nivel_fluencia" value="<?php echo $nivel_fluencia ?>" class="input100">
