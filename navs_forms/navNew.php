...
<nav class="navbar navbar-expand-custom navbar-mainbg">
    <a href="../PaginaInicial.php"><img src="./images/logosjdnv.png" width="50px" height="60px" style="margin-left: 20px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../pag_dicas/browse.php">Dicas</a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" href="../ModoEscuro.php">Configurações</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="./tipo_login.php">Cadastre-se</a>
                </li>
            </ul>
        </div>
    </nav>
