...
//executando o comando sql */
                ...
                echo "<br><br><br><br><a class=btnx href=#altera_candidato_modal> Editar Perfil </a>";
...
<div class="wrap-input100 validate-input" data-validate="Digite o seu cpf: XXXXXXXX-XX">
    <input class="input100" type="text" name="cpf_candidato" id="cpf_candidato" placeholder="CNPJ" readonly value="<?php echo $cpf ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
<div class="wrap-input100 validate-input" data-validate="Digite sua data de nascimento: dd/mm/aaaa">
                <input class="input100" type="text" name="data_nascimento" id="data_nascimento" readonly placeholder="Data de nascimento" onclick="(this.type='date')" value="<?php echo $data_nascimento ?>">
...
<div class="wrap-input101 validate-input" data-validate="Digite seu CEP">
    <input class="borda input102" type="text" id="cep_candidato" name="cep_candidato" placeholder="CEP" value="<?php echo $cep ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
<div class="wrap-input101 validate-input" data-validate="Insira sua rua">
    <input class="input101" type="text" id="rua_candidato" name="rua_candidato" placeholder="Rua" value="<?php echo $rua ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
<div class="wrap-input101 validate-input" data-validate="Insira seu bairro">
    <input class="input101" type="text" id="bairro_candidato" name="bairro_candidato" placeholder="Bairro" value="<?php echo $bairro ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
<div class="wrap-input101 validate-input" data-validate="Insira o número de sua residência">
    <input class="input101" type="text" id="num_candidato" name="num_candidato" placeholder="Número" value="<?php echo $num ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
<div class="wrap-input101 validate-input " data-validate="Insira o complemento: CASA, APTO X">
    <input class="input101" type="text" id="complemento_candidato" name="complemento_candidato" placeholder="Complemento" value="<?php echo $complemento ?>">
    <span class="focus-input100"></span>
    <span class="symbol-input100">
...
echo "</div>";
                ...
                echo "<br><br><a class=btnadd href=../candidato/frm_cadastra_idiomaBOTAO.php> Adicionar </a>";
                echo "<br><br><a class=btnalterar href=../candidato/frm_altera_idioma.php?id=$id_idioma> Alterar </a>";
                echo "<br><br><a class=btnidioma href=../candidato/exclui_idioma.php?id=$id_idioma> Excluir </a>";
                //echo "<a class=btn href=#>Candidate-se</a>";
                echo "</div>";
...
while ($dados = mysqli_fetch_assoc($resultado)) {
    ...
    echo "<br>";
    echo "<br>";
    echo "<br><a class=btn href=../cadastrar_experiencias/exclui_experiencias.php?id=$id> Excluir </a>";
    echo "<br><br><a class=excluir href=frm_cadastra_experiencias.php> Adicionar </a>";
    //echo "<a class=btn href=#>Candidate-se</a>";
    echo "</div>";
