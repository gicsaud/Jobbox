      ...
      <div class="app-content-actions-wrapper">
        ...
        <input type="hidden" class="action-button grid" title="Grid View">
              ...
              <div class="products-area-wrapper tableView">
                ...
                echo "<div class=course-previews>";
                echo "<div class='bloco'>";
                echo "<h6>INFORMAÇÕES PESSOAIS</h6>";
                echo "<h2>$nome</h2>";
                echo "</div>";
                echo "</div>";
                ...
                echo "<h6> Data de Nascimento: <br> > $nascimento_formatado</h6>";
               
                
                echo "<h6><br> Formas de contato: <br> > Telefone: $telefone <br> > Email: $email</h6>";
                
                echo "<h6> <br> Endereço: <br> > Cep: $cep <br> > Rua: $rua <br> > Bairro: $bairro <br> > Número: $num <br> > Complemento: $complemento </h6>";
                echo "<h6><br>  Categoria de CNH: <br> > $categoria_cnh</h6>";
                echo "<br>";
                echo "<br>";
                
                echo "<br><br><a class=btns href=frm_altera_candidato.php?id=$id> Alterar </a>";
