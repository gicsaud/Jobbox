...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Meu Perfil - Criar Vagas</h1>
...
//definindo o comando sql a ser usado */
                $comandoSqlFoto="select * from tb_foto_perfil_empresa";

//executando o comando sql */
                $resultadoFoto=mysqli_query($con,$comandoSqlFoto);
                $dadosFoto=mysqli_fetch_assoc($resultadoFoto);
                $id=$dadosFoto["id_foto_perfil_empresa"];
                
                $i=$dadosFoto["imagem_empresa"];
                ...
                echo "<div class='info'>";
                echo "<h1>$nome</h1>";
                echo "<p class='role' style='color: black;'>Empresa</p>";
                ...
                echo "<div class='title'>
                      <h2 style='color: #9d3fd1;'>Informações da Empresa</h2>
                      </div>";
                      echo "<br>";
                echo "<div class='icon'>
                ...
                <div class='info-field'>
                    <h3 style='color: #9d3fd1;'>CNPJ</h3>
                    <p style='color: black;'>$cnpj</p>
                </div></div>";    
                echo "<div class='info-body'>
                
                <div class='info-field'>
                    <h3 style='color: #9d3fd1;'>Telefone de Contato</h3>
                ...
                echo "<br>";
                echo "<br>";
                echo "<br><br><a class=btnx href=#altera_empresa_modal> Editar Perfil </a>";
                ?>
                <div id=altera_empresa_modal class=modal>";
    ...
    <form class="login100-form validate-form" action="altera_empresa.php" method="POST">
        ...
        <span class="login107-form-title">
                Editar Perfil
            </span>
        <input class="input100" type="hidden" id="id_empresa" name="id_empresa" readonly value="<?php echo $id_empresa ?>">
            ...
            <div class="wrap-input100 validate-input" data-validate="Nome inválido: Digite o nome completo">
                <input class="input103" type="text" name="nome_empresa" id="nome_empresa" placeholder="Nome" value="<?php echo $nome ?>">
            ...
            <div class="wrap-input100 validate-input" data-validate="Digite o seu cpf: XXXXXXXX-XX">
                <input class="input100" type="text" name="cnpj_empresa" id="cnpj_empresa" placeholder="CNPJ" readonly value="<?php echo $cnpj ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input101 validate-input" data-validate="Digite seu CEP">
                <input class="borda input109" type="text" id="cep_empresa" name="cep_empresa" placeholder="CEP" value="<?php echo $cep ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input101 validate-input" data-validate="Insira sua rua">
                <input class="input101" type="text" id="rua_empresa" name="rua_empresa" placeholder="Rua" value="<?php echo $rua ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input101 validate-input" data-validate="Insira seu bairro">
                <input class="input101" type="text" id="bairro_empresa" name="bairro_empresa" placeholder="Bairro" value="<?php echo $bairro ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input101 validate-input" data-validate="Insira o número de sua residência">
                <input class="input101" type="text" id="num_empresa" name="num_empresa" placeholder="Número" value="<?php echo $num ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input101 validate-input " data-validate="Insira o complemento: CASA, APTO X">
                <input class="input101" type="text" id="complemento_empresa" name="complemento_empresa" placeholder="Complemento" value="<?php echo $complemento ?>">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="container-login100-form-btn">
                    <input type="submit"  class="login105-form-btn" value="Alterar">
 ...
 <button><a href=#fechar title=Fechar class=fechar> X </a> </button>
    ...
    <form class="login100-form validate-form" action="altera_vaga.php" method="POST">
        ...
        <input class="input104" type="hidden" id="id_vaga" name="id_vaga" readonly value="<?php echo $id_vaga ?>">

        <span class="login100-form-title">
                    Alterar Vaga
                </span>

                <div class="wrap-input102 validate-input" data-validate="Nome inválido: Digite o nome da empresa !">
                    <input class="input108" type="text" name="nome_empresa" id="nome_empresa" placeholder="Nome empresa" value="<?php echo $nome_empresa ?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input102 validate-input" data-validate="Nome inválido: Digite o salário !">
                    <input class="input104" type="text" name="salario_vaga" id="salario_vaga" placeholder="Salario" value="<?php echo $salario_vaga ?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input102 validate-input" data-validate="Digite a carga horária !">
                    <input class="input104" type="text" name="carga_horaria" id="carga_horaria" placeholder="Carga horária" value="<?php echo $carga_horaria?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">

                    </span>
                </div>
                <div class="wrap-input102 validate-input" data-validate="Digite os requisitos !">
                    <input class="input104" type="text" name="requisitos_vaga" id="requisitos_vaga" placeholder="Requisitos" value="<?php echo $requisitos_vaga ?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">

                    </span>
                </div> <div class="wrap-input102 validate-input" data-validate="Digite o cargo !">
                    <input class="input104" type="text" name="cargo_vaga" id="cargo_vaga" placeholder="Cargo" value="<?php echo $cargo_vaga ?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">

                    </span>
                </div>
                <div class="wrap-input102 validate-input" data-validate="Digite a quantidade de vagas!">
                    <input class="input104" type="text" name="quantidade_vaga" id="quantidade_vaga" placeholder="Quantidade" value="<?php echo $quantidade_vaga ?>">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
