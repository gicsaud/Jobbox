...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Candidatos</h1>
        ...
        <input type="hidden" class="action-button grid" title="Grid View">
              ...
              <?php
                ...
                $fetch = $buscaUser->fetchAll();
                 ...
                 $comandoSqlCandidato="select * from tb_candidato";
                 $resultado2=mysqli_query($con,$comandoSqlCandidato);
                 ...
                 while ($dados = mysqli_fetch_assoc($resultado)) {
                   ...
                   echo "</div>";
                   echo "<br>";
                   echo "<h6> O candidato $nome mostrou interesse em sua vaga para $cargo_vaga</h6>";
                   echo "<br>";
                   echo "<h6> Entre em contato com ele(a).</h6>";
                   echo "<br>";
                   echo "<br>";
                   echo "<br>";
                   echo "<br>";
                   echo "<br>";
                   echo "<a class='btn' href='../PerfilCandidato/index.php'> Visitar Perfil </a>";
