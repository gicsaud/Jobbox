...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Pefil Empresa <?php echo $nome; ?> </h1>
                ...
                while ($dados = mysqli_fetch_assoc($resultado)) {
                  ...
                  foreach($fetch as $usuarios){
                    ...
                    if($usuarios['status'] == 0){
                       $status = "<a class='btn' id='assinar' ip='".$usuarios["cod_candidato"]."' ir='".$usuarios["cod_empresa"]."' > Candidatar-se </a>";
                    }else if($usuarios['status'] == 1){
                       $status = "<a class='btn' id='assinar' ip='".$usuarios["cod_candidato"]."' ir='".$usuarios["cod_empresa"]."' > Desistir </a>";
                              ...
                              $status = "<a   class='btns' > Desistir </a>" ;
                                }
                                   echo $status;
                    }
                  echo "</div>";
