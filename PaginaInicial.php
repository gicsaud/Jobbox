...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./navs_deslogado/style.css">
  ...
  <div id="js-preloader" class="js-preloader">
    <div class="preloader-inner">
      ...
      <?php include './navs_deslogado/navNew.php';
      ?>
    ...
    <p style="color: #985bce;">Acesso rápido</p>
      ...
      <div class="access-links">
        <div class="access-link-wrapper">
          ...
          <a href="./tipo_cadastro.php">
          <div class="access-icon">
           <img src="./prototipo_acesso rapido/dist/imagens/cadastrar_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image"></a>
              <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/>
              <circle cx="8.5" cy="8.5" r="1.5"/>
              <polyline points="21 15 16 10 5 21"/>
            </svg>
          </div>
          <span class="access-text">Junte-se a nós</span>
        </div>
        <div class="access-link-wrapper">
           <a href="./pag_dicas/browse.php">
          <div class="access-icon">
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./FAQ/FAQ.php"> <img src="./prototipo_acesso rapido/dist/imagens/ajuda_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-left"></a>
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./ModoEscuro.php"> <img src="./prototipo_acesso rapido/dist/imagens/configuracoes_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-left"></a>
        ...
        <div class="access-link-wrapper">
          <div class="access-icon">
          <a href="./tipo_login.php"><img src="./prototipo_acesso rapido/dist/imagens/entrar_icon2.png" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"></a>
              <polygon points="12 2 2 7 12 12 22 7 12 2"/>
              <polyline points="2 17 12 22 22 17"/>
              <polyline points="2 12 12 17 22 12"/>
            </svg>
          </div>
          <span class="access-text">Entrar</span>
        </div>
    ...
    <div class="project-box-wrapper">
      <div class="project-box" style="background-color: #b585dd;">
        ...
        <div class="project-box-content-header">
          ...
          <p class="box-content-subheader">O mundo pode fazer tudo por você, menos a sua parte. Conte com nossa a ajuda!</p>
        </div>
...
<script src="vendor/tilt/tilt.jquery.min.js"></script>
    ...
    <script  src="./navs_deslogado/script.js"></script>
