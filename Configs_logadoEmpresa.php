...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="./navs_configEmpresa/style.css">
...
<link rel="stylesheet" type="text/css" href="./css/preloader.css">
  ...
  <?php include './navs_configEmpresa/navNew.php'; ?>
  <body>
...
<div class="accordion js-accordion">
  ...
  <div class="accordion-body js-accordion-body">
    <div class="accordion-body__contents">
    <a href="./empresa/enviar_email.php" style="text-decoration: none;text-align: left;"><input type="button" value="Senha Empresa" class="login100-form-btn" style="text-align: center !important;">
             </a>
  ...
  <div class="accordion-body js-accordion-body">
    <div class="accordion-body__contents">
    <a href="./sairEmpresa.php" style="text-decoration: none;text-align: left;"><input type="button" value="Sair" class="login100-form-btn" style="text-align: center !important;">
             </a>
  ...
  <script src="./navs_configEmpresa/script.js"></script>
