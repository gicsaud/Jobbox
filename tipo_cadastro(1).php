        ...
        <form class="login100-form validate-form">
          <span class="login100-form-title">
           Qual tipo de conta deseja criar?
			 ...
			 <a href="./empresa/frm_cadastrar_empresa.php"> <input type="button" value="Empresa" class="login100-form-btn">
             </a>
          <br>
         
           <a href="./candidato/frm_cadastra_candidato.php"> <input type="button" value="Candidato" class="login100-form-btn"></a>
