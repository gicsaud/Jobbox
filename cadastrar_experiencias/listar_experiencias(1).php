...
<html lang="en">
    ...
    <link rel="stylesheet" href="css/card.css">
        ...
        <link rel="stylesheet" type="text/css" href="../sidebar/dist/style.css">
        <link rel="stylesheet" type="text/css" href="css/util.css">
        <link rel="stylesheet" type="text/css" href="../nav_dicas/style.css">
    </head>
    ...
    <body>
            ...
            <?php  include '../sidebar/dist/sidebar.php';?>
            <?php include '../nav_dicas/navbar.php';?>
        <main>
<?php
...
?>
        ...
        <script src="../nav_dicas/script.js"></script>
    </body>
