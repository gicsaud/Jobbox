...
<body>
	<nav class="navbar" style="object-position: left;">
		...
		<div class="div">
			...
			<ul>
				<li>
					<a class="navlink" href="frm_cadastra_experiencias.html">Nova Empresa</a>
				</li>
			...
			<div class="col mt-5">
                ...
                include("conexao.php");
					switch(@$_REQUEST["page"]){
						case "nova-empresa";
							include("frm_cadastra_experiencias.html");
						break;
						case "listar-empresa";
							include("listar_experiencias.php");
						break;
                        case 'salvar-empresa':
                            include("cadastra_experiencias.php");
                            break;
						default;
