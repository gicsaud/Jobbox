    ...
    <a href="#"><img src="./images/logosjdnv.png" width="40px" height="50px" style="margin-left: 20px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../PaginaInicial.php"></i>Página Inicial</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="../pag_dicas/browse.php"></i>Dicas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0);"></i>Vagas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0);"></i>Meu Perfil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../ModoEscuro.php"></i>Configurações</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../sairCandidato.php"></i>Sair</a>
                </li>
            </ul>
        </div>
    </nav>
